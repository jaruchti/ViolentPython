# Book example of a small Scapy library to duplicate packet layers
...
def dupDop11(pkt):
  ...
  SC=dPkt.SC
  addr4=dPkt.addr4
  nPkt=Dot11(subtype=subtype, type=Type, proto=proto, FCfield=FCfield, \
             ID=ID, addr1=addr1, addr2=addr2, addr3=addr3, SC=SC, addr4=addr4)
  return nPkt
