# Book example of taking control of a Parrot UAV drone using Python
...
NAVPORT = 5556
LAND = '290717696' # Command to land the UAV
EMER = '290717952' # Command for emergency landing
TAKEOFF = '290718208' # Command for takeoff
